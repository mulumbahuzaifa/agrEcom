                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                @if ($order->status == 'ordered')
                                    <a href="#" wire:click.prevent="cancelOrder" style="margin-right: 20px;" class="btn btn-success pull-right">Cancel Order</a>
                                @endif
                            </div>
                        </div>
                    </div>
                    <div class="pane-boddy">
                        <table class="table">
                            <tr>
                                <th>Order ID</th>
                                <td>{{ $order->id }}</td>
                            ...
                            <ul class="products-cart">
                                ...
                                <li class="pr-cart-item">
                                    <div class="product-image">
                                        <figure><img src="{{ asset('images/products') }}/{{ $item->product->image }}" alt="{{ $item->product->name }}"></figure>
                                    </div>
