                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                @foreach ($sliders as $slider)
                                    <tr>
                                        <td>{{ $slider->id }}</td>
                                        <td><img src="{{ asset('images/sliders') }}/{{ $slider->image }}" alt="{{  $slider->title }}" width="60"></td>
                                        <td>{{ $slider->title }}</td>
                                        ...
                                        <td>
                                            ...
                                            <a href="#"  wire:click.prevent="deleteSlide({{ $slider->id }})" style="margin-left: 20px"><i class="fa fa-times fa-2x text-danger"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
