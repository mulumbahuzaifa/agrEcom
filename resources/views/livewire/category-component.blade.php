        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-7">
                    <h1 class="__title"> Category: {{ $category_name }}</h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-8 col-lg-9">
                            ...
                            <div class="row align-items-center justify-content-between">
                                <div class="col-auto">
                                    <span class="goods-filter-btn-open js-toggle-filter"><i class="fa fa-filter"></i>Filter</span>
                                </div>
                                ...
                                <div class="col-auto">
                                  <h4 class="h6 widget-title">Category: {{ $category_name }}</h4>
                                </div>
                            </div>
