                            ...
                            <tbody>
                                @foreach ($orders as $order)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                <button class="btn btn success btn-sm dropdown-toggle" type="button" style="color: whitesmoke" data-toggle="dropdown">Status <span class="caret"></span></button>
