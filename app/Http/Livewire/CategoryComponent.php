...
class CategoryComponent extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.category-component', ['products' => $products, 'categories' => $categories, 'lproducts' =>$lproducts, 'category_name' => $category_name, 'popular_products' =>$popular_products])->layout('layouts.base');
    }
}